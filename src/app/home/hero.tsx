...
export default function Hero() {
  return (
    <div className="relative font-Inter overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 mx-auto px-4 sm:px-6 lg:px-8 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-28 min-h-screen flex flex-col justify-end items-center text-center">
        {/* Main Heading */}
        <motion.h1
