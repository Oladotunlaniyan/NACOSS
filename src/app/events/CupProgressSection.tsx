            ...
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-start">
                    ...
                    <div className="cup-progress-text w-full mt-[48px]">
                        <h4 className="text-4xl font-semibold xl:ml-[48px]">Our Chancellor Cup's Progress</h4>
                        <br />
                        <br />
                    ...
                    <div className="xl:ml-[48px] w-full relative w-full h-64 sm:h-72 lg:h-80 overflow-hidden">
                        <Image
                            src={cupImg}
